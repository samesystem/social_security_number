...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{It provides validators for national identification numbers. Currently the following countries are supported: Belgium, China, Denmark, Germany, France, Italy, Lithuania, Netherlands, Norway, Sweden, United Kingdom }
